...
class BinarySearchTree {
   ...
   * 3. 삭제할 노드에 자식이 두개 있으면 삭제할 노드 다음으로 큰 값을 갖는 노드를 찾는다.
   *    삭제할 노드의 오른쪽 노드에서 왼쪽 노드가 없는 노드를 찾는다. 찾은 노드를 삭제할 노드 위치에 넣는다.
   *    이때, 찾은 노드의 오른쪽 자식이 있으면 찾은 노드의 부모의 왼쪽에 오른쪽 자식을 넣는다.
   */
